...
const DEFAULT_BEHIND_GRADIENT = "radial-gradient(farthest-side circle at var(--pointer-x) var(--pointer-y),rgba(30, 58, 138, var(--card-opacity)) 0%,rgba(37, 99, 235, calc(var(--card-opacity) * 0.8)) 50%,rgba(59, 130, 246, calc(var(--card-opacity) * 0.6)) 100%)";

const DEFAULT_INNER_GRADIENT = "linear-gradient(135deg, rgba(30, 58, 138, 0.3) 0%, rgba(30, 64, 175, 0.2) 50%, rgba(37, 99, 235, 0.3) 100%)";
